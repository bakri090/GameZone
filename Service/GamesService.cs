...
namespace GameZone.Service
{
	public class GamesService : IGamesService
	{
		...
		{
			return await _context.Games.Include(g => g.Devices).ThenInclude(d => d.Device)
		...
		{
			return  _context.Games.Include(g => g.Devices).ThenInclude(d => d.Device)
				.Include(g => g.category).AsNoTracking().SingleOrDefault(g => g.Id == id);
		}
		...
		public async Task<Game?> Update(EditGameFormViewModel model)
		{
			...
			game.Decsription = model.Description;
